    ...
    <div className="text-white p-8 bg-neutral-900 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 ">
        {projects.map((projects, index) => (
          <div key={index} className="shadow-2xl shadow-indigo-900 bg-black text-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-xl transform hover:scale-105 transition duration-300 ">
            <img
        src={projects.image}
        alt={projects.title}
      ...
      />
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-2 text-white font-mono">{projects.title}</h3>
              <p className="text-gray-400 mb-2 font-mono">{projects.description}</p>
              <div>
                <a
